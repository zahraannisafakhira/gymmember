...
<body>
    <div class="container">
        <h1 class="mt-4">Details Class</h1>
        <?php
        include 'koneksi.php';
        ...
        ?>
                ...
                <form action="proses_Details.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="class_name" id="class_name" value="<?php echo $row['class_name']; ?>" readonly>
                    </div>

                    <div class="form-group">
                        <label>Price:</label>
                        <input type="text" class="form-control" name="price" id="price" value="<?php echo $row['price']; ?>" readonly>
                    </div>
